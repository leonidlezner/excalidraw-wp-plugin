...
class Excalidraw_Admin
{
  ...
  public function admin_menu()
  {
    ...
    add_menu_page(__('Drawings', $this->plugin_name), 'Excalidraw', 'manage_options', 'excalidraw', array($this, 'admin_menu_display'), 'data:image/svg+xml;base64,' . base64_encode($icon), 11);
  }
  ...
  public function admin_menu_display()
  {
    ...
    if (self::is_view('edit')) {
      ...
      $docTitle = __("Drawing", $this->plugin_name) . " " . date('Y-m-d H.i.s', time());
      $docId = "";
  ...
  public function admin_handler_delete()
  {
    ...
    if ($doc) {
      ...
      $this->set_message(sprintf(__("Document '%s' was successfully deleted!", $this->plugin_name), $doc->title), 'success');
    }
  ...
  public function register_block()
  {
    ...
    $script_handle = generate_block_asset_handle('excalidraw/excalidraw-block', 'editorScript');

    wp_set_script_translations($script_handle, 'excalidraw', plugin_dir_path(dirname(__FILE__)) . 'admin/excalidraw-block/languages') or die();
  }
